...
class Projects extends React.Component {
    ...
    render() {
        if (this.props.isMobileSized) {
            return (
                <div class="mobile">
                    <Container className="project-container-mobile">
                        <h2 class="project-title-mobile">Projects</h2>
    
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    <div class="images">
                                        <i class="far fa-folder-open fa-7x"></i>
                                        <a class="folder" href="https://github.com/mattmkim/safe-roads" target="_blank"> 
                                            <i class="fab fa-github fa-5x"></i>
                                        </a>
                                    </div>
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Safe Roads</h4>
                                        <p class="card-info-mobile">Final project for CIS 550: Database and Information Systems. Web app to explore the relationship between U.S. accident and weather data.</p>
                                        <p class="card-tech-mobile">Tech Used: Javascript, Node, Express, SQL, MongoDB, Heroku</p>
                                    </div>
                                </div>
                            </Card>
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Penn Safety</h4>
                                        <p class="card-info-mobile">Final project for CIS 350: Software Engineering. Platform to centralize student submitted tips and alerts.</p>
                                        <p class="card-tech-mobile">Tech Used: Javascript, Node, Express, MongoDB, Google Maps API</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Facebook Messenger Chatbot</h4>
                                        <p class="card-info-mobile">Built a chatbot using the Messenger Platform to help facilitate new relationships in my community. The bot polls and pairs users to meet with each other weekly.</p>
                                        <p class="card-tech-mobile">Tech Used: Javascript, Node, Express, EJS, MongoDB</p>
                                    </div>
                                </div>
                            </Card>
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Protein-Protein Interface Filtering</h4>
                                        <p class="card-info-mobile">Developed naive and machine learning approach to filtering out false protein-protein interface predictions. Developed clustering algorithm to consider both spatial and chemical properties of atoms.</p>
                                        <p class="card-tech-mobile">Tech Used: Python, Pandas, Scipy, Pytorch, VMD</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Facebook Clone</h4>
                                        <p class="card-info-mobile">Final project for NETS 212: Scalable and Cloud Computing. Built a Facebook replica with two other classmates. </p>
                                        <p class="card-tech-mobile">Tech Used: Javascript, React, Node, Express, AWS, EC2, MapReduce</p>
                                    </div>
                                </div>
                            </Card>
                            <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">All-NBA Team Prediction</h4>
                                        <p class="card-info-mobile">Developed a machine learning model using SVMs to predict the All-NBA teams.</p>
                                        <p class="card-tech-mobile">Tech Used: Python, Pandas, Scikit-Learn, Matplotlib, Seaborn</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            {/* <Card className="card-project-mobile">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        <h4 class="card-title-mobile">Minesweeper</h4>
                                        <p class="card-info-mobile">Implementation of the classic minesweeper game.</p>
...
export default withWindowDimensions(Projects);